...
public partial class MarkerPageFooterViewModel : ObservableObject, IDisposable
{
    ...
    private void OnAppStateChanged(object? sender, PropertyChangedEventArgs? e)
    {
        ...
        {
            ActiveSettingStatus.IsActive = _appState.StateType switch
            {
            ...
            ActiveVersionStatus.IsActive = _appState.StateType == MainStateType.Version;
        }
    }
    ...
    [RelayCommand]
    private void VersionInformationButton(object parameter)
    {
        var preStatus = _appState.StateType;
        _appState.StateType = MainStateType.Version;
