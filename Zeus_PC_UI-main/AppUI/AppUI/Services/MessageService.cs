...
public class MessageService
{
    public static string GetMessage(MessageCode code)
    {
        return code switch
        {
            ...
            MessageCode.DlgMsgImportPositionSelect => "CT撮影体位を設定してください",
            MessageCode.DlgMsgImportPositionExec =>   "{0}で3D化を開始していいですか？",
            //  - 3Dデータリスト
...
public enum MessageCode
{
    ...
    DlgMsgImportPositionSelect,     // CT撮影体位を設定してください
    DlgMsgImportPositionExec,       // {0}で3D化を開始していいですか？
