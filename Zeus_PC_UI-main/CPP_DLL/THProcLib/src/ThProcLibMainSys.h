...
public:
	...
	//
	void checkCallLoggerDog(void);
	//#221_added_dll_called_log
	bool get_dll_called_log(void) override {
		return m_enable_dll_called_log;
	}
protected:
	...
	//#221_added_dll_called_log
	bool m_enable_dll_called_log;
	ExeThreader m_thread_cmd_dog; 
};
